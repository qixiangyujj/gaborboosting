...
public:
    ...
    void run();
    void clear();
    void run(CvFeret* feret);
    void preparefile(CvFeret* feret);
    void process40Gabor(IplImage* img, int index);
    IplImage* reducebyscale(IplImage *src, int Nu);
    void img2feature(IplImage *img, int Nu, int Mu, int index);
    void runferet(CvFeret *feret, CvPoolParams *param);
